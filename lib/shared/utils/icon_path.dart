class IconPath {
  ...
  static const String filter = "${iconPath}filter$extensionPath";
  static const String heart = "${iconPath}heart$extensionPath";
  static const String home = "${iconPath}home$extensionPath";
  static const String note = "${iconPath}note$extensionPath";
  static const String notification = "${iconPath}notification$extensionPath";
